...
const Map<int, String> QUESTION_TEXT_KR = {
  ...
  2 : "가장 이상적인 주말은?",
  3 : "짝궁과 싸운 날은?",
  4 : "원래 다니던 곳에서 우연히 도깨비 도로라고 쓰여진 곳을 발견할 때?",
  5 : "데이트 중 공원을 거닐다가 연인이 갑자기 조용해졌는데 그 이유는?",
  6 : "재미있는 영화에 대해 연인한테 말할 때?",
  7 : "오늘 힘들었다고 말하는 짝궁에게?",
  8 : "바다에서 일몰을 보며..",
  9 : "학창 시절에 대해 설명할 때?",
  10 : "데이트를 하게 된다면?",
  11 : "데이트룩을 입을 때는?",
  12 : "여행 중 예기치 못하게 돌발상황..?"
};

const Map<int, String> ANSWER_TEXT_1_KR = {
  1 : "그 친구 커플 얘기 많이 들었는데! 재밌겠다! ",
  2 : "짝궁과 데이트, 친구 모임 등 금요일부터 달릴 생각하니까 신난다!",
  3 : "친한 친구한테 털어놓고 나니 마음이 편해진다",
  4 : "원래 다니던 곳이 가장 짧은 거리이니 원래대로 가자 ",
  5 : "공원 지도를 보고 동선을 고민 중이다",
  6 : "줄거리와 인상깊었던 장면들에 대해 얘기한다 ",
  7 : "왜? (듣고 나서) 그럼 이렇게 해보면 나아지지 않을까?",
  8 : "해가 이 방향으로 지는 거 보면 여기가 서쪽인가? 해는 일몰일 때 왜 빨간색으로 변할까?",
  9 : "초중고등학교를 서울의 같은 동네서 나왔고 이사간 적은 없었어",
  10 : "일단 짝궁과 편한 곳에서 만나서 얘기하며 정한다",
  11 : "데이트 가는 날 옷을 입으며 손이 가는 옷을 입는다",
  12 : "기왕 이렇게 된거, 마음가는 대로 가보자 ",
};

const Map<int, String> ANSWER_TEXT_2_KR = {
  1 : "우리 둘만 놀아도 재밌는데 굳이….",
  2 : "주말 중 하루는 짝궁과 데이트하더라도 나머지 하루는 나만의 휴식, 충전시간이 있으면 좋겠어 ",
  3 : "집에서 혼자 영화보고 낮잠자면서 마음을 달랜다",
  4 : "왠지 더 재밌을 것같으니까 도깨비 도로로 가보자",
  5 : "공원 내 조각품을 보며 몽상 중이다",
  6 : "영화의 함축적인 의미와 새로운 결말 가능성에 대해 얘기한다",
  7 : "(감정이입) 정말 힘들었겠다",
  8 : "햇빛과 바다의 색이 너무 아름답다. 너와 함께 있어서 더 행복해~",
  9 : "초등학교 때 동네 친구들이랑 놀이터에서 놀 때 제일 좋았어",
